...
Before using the BOIPA Gateway PHP SDK you should be familiar with the contents of the [API Specification for Merchants](https://github.com/BOIPA/BOIPA_Gateway_PHP_SDK/blob/master/docs/BOIPA%20Gateway%20-%200%20-%20Overview.pdf) document as it describes all fields and their meaning within a given payment transaction.
